        ...
        <div className="selected-order">
            <div className="top-details">
                <div className="order-summary-details">
                    <p><strong>Ordered on:</strong> {dateFormatter(orderDetails.created)}</p>
                </div>
                <div className="delivery-details">
                    <p><strong>For:</strong> {orderDetails.client.name}</p>
                    <p><strong>Address:</strong> {orderDetails.client.address}</p>
                    <p><strong>phoneNumber:</strong> {orderDetails.client.phoneNumber}</p>
                </div>
            </div>
            ...
            <div className="full-order-summary">
                <p><strong>Products Total:</strong> ${orderDetails.totalCost.toFixed(2)}</p>   
            </div>
        </div>
    )
}